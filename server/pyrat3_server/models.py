...
class Client(models.Model):
    ...
    command_id = models.CharField(max_length=6, null=True, default='empty')
    command_datetime = models.DateTimeField(default=strftime('%Y-%m-%d %H:%M:%S', gmtime(0)))
    command = models.TextField(max_length=20, null=True, default='empty')
    command_args = models.TextField(max_length=500, null=True, default='{}')
    command_result = models.TextField(max_length=5000, null=True, default='empty')
